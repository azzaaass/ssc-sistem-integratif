        ...
        <table class="min-w-full bg-white rounded-lg overflow-hidden">
            ...
            <tbody id="surat-table-body" class="text-gray-700">
                ...
                @foreach ($surats as $surat)
                    @if ((isset($surat->pic->id_admin) ? $surat->pic->id_admin : '') == Auth::id())
                        <tr class="text-sm even:bg-gray-100">
                            ...
                            <td class="px-4"><a href="/detailSuratPic/{{ $surat->id }}">
                                    <p class="bg-[#013056] w-fit rounded text-xs text-white py-1 px-2 font-semibold">Detail
                                    </p>
                                </a></td>
                        </tr>
                    @endif
                    ...
                    $.each(resoponse.surats, function(key, value) {
                        ...
                        $("#surat-table-body").append(
                            ...
                            "<td class='py-3 px-4'>" + moment(value.created_at).format(
                                'dddd, D MMMM YYYY') + "</td>" +
                            "<td class='py-3 px-4'><a href='detailSuratPic/" + value.id +
