    ...
    <div id="panel-delete"
        ...
        <div class="flex items-center justify-between">
            <form action="/surats/{{ $surat->id }}" method="POST">
                @csrf
                @method('DELETE')
                <button type="submit" class="text-sm bg-gradient-to-b from-[#ED212B] to-[#B6272C] hover:to-[#ED212B] text-white font-semibold py-2 px-10 rounded focus:outline-none focus:shadow-outline">Ya,
                    Hapus</button>
            </form>
            <button class="text-sm bg-gradient-to-b from-gray-200 to-gray-300 hover:to-gray-400 text-gray-800 font-semibold py-2 px-10 rounded focus:outline-none focus:shadow-outline"
        ...
        <div class="max-w-5xl mx-auto bg-white shadow-md rounded-lg px-20 py-14">
            <form action="/surats" method="POST">
                ...
                <div class="flex justify-between gap-16 items-center">
                    <div class="mt-5 w-full">
                        <label for="alat" class="block tx-gray text-sm font-semibold mb-1.5">Nama Alat</label>
                        <select type="text" id="alat" name="input2" onclick="getDataAlat(this)"
                    ...
                    <div class="mt-5 w-full">
                        @if ($surat->input2 != $surat->input2_revisi)
                            <label for="alat_revisi" class="block tx-gray text-sm font-semibold mb-1.5">Nama
                                Alat (incoming)</label>
                            <select type="text" id="alat_revisi" name="input2" onclick="getDatAalat(this)"
                                required
                                class="text-sm bg-white appearance-none border border-gray-400 rounded w-full py-2 px-3 tx-gray leading-tight focus:border-[#C16A0B] focus:outline-none">
