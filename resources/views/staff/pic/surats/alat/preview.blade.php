...
@section('container')
    ...
    <div class="max-w-xl mx-auto bg-white shadow-md rounded-lg px-20 py-14">
        <form action="/pic/surats" method="POST">
            @csrf
            @method('PUT')
            <!-- Nama Peminjam -->
            <div class="mt-5">
            ...
            <div class="mt-5">
                ...
                <select type="text" id="alat" name="input2" required
            ...
            <div class="flex w-full justify-end">
                <button type="submit"
                    class="text-sm bg-gradient-to-b from-[#C16A0B] to-[#8A4F0E] hover:to-[#C16A0B] text-white font-semibold py-2 px-10 rounded focus:outline-none focus:shadow-outline">Submit
                    Hasil</button>
            </div>
        </form>
    </div>
